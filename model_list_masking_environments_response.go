...
// checks if the ListMaskingEnvironmentsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListMaskingEnvironmentsResponse{}
...
func NewListMaskingEnvironmentsResponse() *ListMaskingEnvironmentsResponse {
	this := ListMaskingEnvironmentsResponse{}
	return &this
}
...
type NullableListMaskingEnvironmentsResponse struct {
	value *ListMaskingEnvironmentsResponse
	isSet bool
}

func (v NullableListMaskingEnvironmentsResponse) Get() *ListMaskingEnvironmentsResponse {
	return v.value
}

func (v *NullableListMaskingEnvironmentsResponse) Set(val *ListMaskingEnvironmentsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListMaskingEnvironmentsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListMaskingEnvironmentsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListMaskingEnvironmentsResponse(val *ListMaskingEnvironmentsResponse) *NullableListMaskingEnvironmentsResponse {
	return &NullableListMaskingEnvironmentsResponse{value: val, isSet: true}
}
