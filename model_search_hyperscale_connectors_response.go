...
// checks if the SearchHyperscaleConnectorsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SearchHyperscaleConnectorsResponse{}
...
func NewSearchHyperscaleConnectorsResponse() *SearchHyperscaleConnectorsResponse {
	this := SearchHyperscaleConnectorsResponse{}
	return &this
}
...
type NullableSearchHyperscaleConnectorsResponse struct {
	value *SearchHyperscaleConnectorsResponse
	isSet bool
}

func (v NullableSearchHyperscaleConnectorsResponse) Get() *SearchHyperscaleConnectorsResponse {
	return v.value
}

func (v *NullableSearchHyperscaleConnectorsResponse) Set(val *SearchHyperscaleConnectorsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableSearchHyperscaleConnectorsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableSearchHyperscaleConnectorsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSearchHyperscaleConnectorsResponse(val *SearchHyperscaleConnectorsResponse) *NullableSearchHyperscaleConnectorsResponse {
	return &NullableSearchHyperscaleConnectorsResponse{value: val, isSet: true}
}

func (v NullableSearchHyperscaleConnectorsResponse) MarshalJSON() ([]byte, error) {
