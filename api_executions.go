...
func (r ApiCleanupExecutionRequest) Execute() (*CleanupExecutionResponse, *http.Response, error) {
	return r.ApiService.CleanupExecutionExecute(r)
}

/*
CleanupExecution Cleanup an Execution (Hyperscale only).
...
func (a *ExecutionsAPIService) CleanupExecutionExecute(r ApiCleanupExecutionRequest) (*CleanupExecutionResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/executions/{executionId}/cleanup"
	localVarPath = strings.Replace(localVarPath, "{"+"executionId"+"}", url.PathEscape(parameterValueToString(r.executionId, "executionId")), -1)
...
func (r ApiGetExecutionLogRequest) Execute() (*ExecutionLog, *http.Response, error) {
...
func (a *ExecutionsAPIService) GetExecutionLogExecute(r ApiGetExecutionLogRequest) (*ExecutionLog, *http.Response, error) {
	...
	localVarPath := localBasePath + "/executions/{executionId}/log"
	localVarPath = strings.Replace(localVarPath, "{"+"executionId"+"}", url.PathEscape(parameterValueToString(r.executionId, "executionId")), -1)
...
func (r ApiRestartExecutionRequest) Execute() (*RestartExecutionResponse, *http.Response, error) {
	return r.ApiService.RestartExecutionExecute(r)
}

/*
RestartExecution Restart an Execution (Hyperscale only).
...
func (a *ExecutionsAPIService) RestartExecutionExecute(r ApiRestartExecutionRequest) (*RestartExecutionResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/executions/{executionId}/restart"
	localVarPath = strings.Replace(localVarPath, "{"+"executionId"+"}", url.PathEscape(parameterValueToString(r.executionId, "executionId")), -1)
