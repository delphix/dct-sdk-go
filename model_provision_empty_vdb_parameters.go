...
// checks if the ProvisionEmptyVDBParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProvisionEmptyVDBParameters{}

// ProvisionEmptyVDBParameters struct for ProvisionEmptyVDBParameters
type ProvisionEmptyVDBParameters struct {
	...
	// The ID of the target repository where to provision the VDB. A repository typically corresponds to a database installation. Setting this attribute implicitly determines the environment where to provision the VDB.
	...
	// The ID of the Engine onto which to provision.
	EngineId string `json:"engine_id"`
}

type _ProvisionEmptyVDBParameters ProvisionEmptyVDBParameters

// NewProvisionEmptyVDBParameters instantiates a new ProvisionEmptyVDBParameters object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewProvisionEmptyVDBParameters(repositoryId string, engineId string) *ProvisionEmptyVDBParameters {
	this := ProvisionEmptyVDBParameters{}
	this.RepositoryId = repositoryId
	this.EngineId = engineId
	return &this
}

// NewProvisionEmptyVDBParametersWithDefaults instantiates a new ProvisionEmptyVDBParameters object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewProvisionEmptyVDBParametersWithDefaults() *ProvisionEmptyVDBParameters {
	this := ProvisionEmptyVDBParameters{}
	return &this
}

// GetPreRefresh returns the PreRefresh field value if set, zero value otherwise.
func (o *ProvisionEmptyVDBParameters) GetPreRefresh() []Hook {
...
func (o *ProvisionEmptyVDBParameters) GetPreRefreshOk() ([]Hook, bool) {
	if o == nil || IsNil(o.PreRefresh) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasPreRefresh() bool {
	if o != nil && !IsNil(o.PreRefresh) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetPreRefresh(v []Hook) {
	o.PreRefresh = v
}

// GetPostRefresh returns the PostRefresh field value if set, zero value otherwise.
func (o *ProvisionEmptyVDBParameters) GetPostRefresh() []Hook {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetPostRefreshOk() ([]Hook, bool) {
	if o == nil || IsNil(o.PostRefresh) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasPostRefresh() bool {
	if o != nil && !IsNil(o.PostRefresh) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetPostRefresh(v []Hook) {
	o.PostRefresh = v
}

// GetPreSelfRefresh returns the PreSelfRefresh field value if set, zero value otherwise.
func (o *ProvisionEmptyVDBParameters) GetPreSelfRefresh() []Hook {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetPreSelfRefreshOk() ([]Hook, bool) {
	if o == nil || IsNil(o.PreSelfRefresh) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasPreSelfRefresh() bool {
	if o != nil && !IsNil(o.PreSelfRefresh) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetPreSelfRefresh(v []Hook) {
	o.PreSelfRefresh = v
}

// GetPostSelfRefresh returns the PostSelfRefresh field value if set, zero value otherwise.
func (o *ProvisionEmptyVDBParameters) GetPostSelfRefresh() []Hook {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetPostSelfRefreshOk() ([]Hook, bool) {
	if o == nil || IsNil(o.PostSelfRefresh) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasPostSelfRefresh() bool {
	if o != nil && !IsNil(o.PostSelfRefresh) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetPostSelfRefresh(v []Hook) {
	o.PostSelfRefresh = v
}

// GetPreRollback returns the PreRollback field value if set, zero value otherwise.
// Deprecated
func (o *ProvisionEmptyVDBParameters) GetPreRollback() []Hook {
...
// and a boolean to check if the value has been set.
// Deprecated
func (o *ProvisionEmptyVDBParameters) GetPreRollbackOk() ([]Hook, bool) {
	if o == nil || IsNil(o.PreRollback) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasPreRollback() bool {
	if o != nil && !IsNil(o.PreRollback) {
		return true
	}
...
// Deprecated
func (o *ProvisionEmptyVDBParameters) SetPreRollback(v []Hook) {
	o.PreRollback = v
}

// GetPostRollback returns the PostRollback field value if set, zero value otherwise.
// Deprecated
func (o *ProvisionEmptyVDBParameters) GetPostRollback() []Hook {
...
// and a boolean to check if the value has been set.
// Deprecated
func (o *ProvisionEmptyVDBParameters) GetPostRollbackOk() ([]Hook, bool) {
	if o == nil || IsNil(o.PostRollback) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasPostRollback() bool {
	if o != nil && !IsNil(o.PostRollback) {
		return true
	}
...
// Deprecated
func (o *ProvisionEmptyVDBParameters) SetPostRollback(v []Hook) {
	o.PostRollback = v
}

// GetConfigureClone returns the ConfigureClone field value if set, zero value otherwise.
func (o *ProvisionEmptyVDBParameters) GetConfigureClone() []Hook {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetConfigureCloneOk() ([]Hook, bool) {
	if o == nil || IsNil(o.ConfigureClone) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasConfigureClone() bool {
	if o != nil && !IsNil(o.ConfigureClone) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetConfigureClone(v []Hook) {
	o.ConfigureClone = v
}

// GetPreSnapshot returns the PreSnapshot field value if set, zero value otherwise.
func (o *ProvisionEmptyVDBParameters) GetPreSnapshot() []Hook {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetPreSnapshotOk() ([]Hook, bool) {
	if o == nil || IsNil(o.PreSnapshot) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasPreSnapshot() bool {
	if o != nil && !IsNil(o.PreSnapshot) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetPreSnapshot(v []Hook) {
	o.PreSnapshot = v
}

// GetPostSnapshot returns the PostSnapshot field value if set, zero value otherwise.
func (o *ProvisionEmptyVDBParameters) GetPostSnapshot() []Hook {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetPostSnapshotOk() ([]Hook, bool) {
	if o == nil || IsNil(o.PostSnapshot) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasPostSnapshot() bool {
	if o != nil && !IsNil(o.PostSnapshot) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetPostSnapshot(v []Hook) {
	o.PostSnapshot = v
}

// GetPreStart returns the PreStart field value if set, zero value otherwise.
func (o *ProvisionEmptyVDBParameters) GetPreStart() []Hook {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetPreStartOk() ([]Hook, bool) {
	if o == nil || IsNil(o.PreStart) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasPreStart() bool {
	if o != nil && !IsNil(o.PreStart) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetPreStart(v []Hook) {
	o.PreStart = v
}

// GetPostStart returns the PostStart field value if set, zero value otherwise.
func (o *ProvisionEmptyVDBParameters) GetPostStart() []Hook {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetPostStartOk() ([]Hook, bool) {
	if o == nil || IsNil(o.PostStart) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasPostStart() bool {
	if o != nil && !IsNil(o.PostStart) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetPostStart(v []Hook) {
	o.PostStart = v
}

// GetPreStop returns the PreStop field value if set, zero value otherwise.
func (o *ProvisionEmptyVDBParameters) GetPreStop() []Hook {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetPreStopOk() ([]Hook, bool) {
	if o == nil || IsNil(o.PreStop) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasPreStop() bool {
	if o != nil && !IsNil(o.PreStop) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetPreStop(v []Hook) {
	o.PreStop = v
}

// GetPostStop returns the PostStop field value if set, zero value otherwise.
func (o *ProvisionEmptyVDBParameters) GetPostStop() []Hook {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetPostStopOk() ([]Hook, bool) {
	if o == nil || IsNil(o.PostStop) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasPostStop() bool {
	if o != nil && !IsNil(o.PostStop) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetPostStop(v []Hook) {
	o.PostStop = v
}

// GetTargetGroupId returns the TargetGroupId field value if set, zero value otherwise.
func (o *ProvisionEmptyVDBParameters) GetTargetGroupId() string {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetTargetGroupIdOk() (*string, bool) {
	if o == nil || IsNil(o.TargetGroupId) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasTargetGroupId() bool {
	if o != nil && !IsNil(o.TargetGroupId) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetTargetGroupId(v string) {
	o.TargetGroupId = &v
}

// GetName returns the Name field value if set, zero value otherwise.
func (o *ProvisionEmptyVDBParameters) GetName() string {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetNameOk() (*string, bool) {
	if o == nil || IsNil(o.Name) {
		return nil, false
	}
	return o.Name, true
...
func (o *ProvisionEmptyVDBParameters) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetName(v string) {
	o.Name = &v
}

// GetDatabaseName returns the DatabaseName field value if set, zero value otherwise.
func (o *ProvisionEmptyVDBParameters) GetDatabaseName() string {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetDatabaseNameOk() (*string, bool) {
	if o == nil || IsNil(o.DatabaseName) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasDatabaseName() bool {
	if o != nil && !IsNil(o.DatabaseName) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetDatabaseName(v string) {
	o.DatabaseName = &v
}

// GetCdbId returns the CdbId field value if set, zero value otherwise.
func (o *ProvisionEmptyVDBParameters) GetCdbId() string {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetCdbIdOk() (*string, bool) {
	if o == nil || IsNil(o.CdbId) {
		return nil, false
	}
	return o.CdbId, true
...
func (o *ProvisionEmptyVDBParameters) HasCdbId() bool {
	if o != nil && !IsNil(o.CdbId) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetCdbId(v string) {
	o.CdbId = &v
}

// GetClusterNodeIds returns the ClusterNodeIds field value if set, zero value otherwise.
func (o *ProvisionEmptyVDBParameters) GetClusterNodeIds() []string {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetClusterNodeIdsOk() ([]string, bool) {
	if o == nil || IsNil(o.ClusterNodeIds) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasClusterNodeIds() bool {
	if o != nil && !IsNil(o.ClusterNodeIds) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetClusterNodeIds(v []string) {
	o.ClusterNodeIds = v
}

// GetClusterNodeInstances returns the ClusterNodeInstances field value if set, zero value otherwise.
func (o *ProvisionEmptyVDBParameters) GetClusterNodeInstances() []ClusterNodeInstance {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetClusterNodeInstancesOk() ([]ClusterNodeInstance, bool) {
	if o == nil || IsNil(o.ClusterNodeInstances) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasClusterNodeInstances() bool {
	if o != nil && !IsNil(o.ClusterNodeInstances) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetClusterNodeInstances(v []ClusterNodeInstance) {
...
func (o *ProvisionEmptyVDBParameters) GetTruncateLogOnCheckpoint() bool {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetTruncateLogOnCheckpointOk() (*bool, bool) {
	if o == nil || IsNil(o.TruncateLogOnCheckpoint) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasTruncateLogOnCheckpoint() bool {
	if o != nil && !IsNil(o.TruncateLogOnCheckpoint) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetTruncateLogOnCheckpoint(v bool) {
	o.TruncateLogOnCheckpoint = &v
}

// GetOsUsername returns the OsUsername field value if set, zero value otherwise.
func (o *ProvisionEmptyVDBParameters) GetOsUsername() string {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetOsUsernameOk() (*string, bool) {
	if o == nil || IsNil(o.OsUsername) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasOsUsername() bool {
	if o != nil && !IsNil(o.OsUsername) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetOsUsername(v string) {
	o.OsUsername = &v
}

// GetOsPassword returns the OsPassword field value if set, zero value otherwise.
func (o *ProvisionEmptyVDBParameters) GetOsPassword() string {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetOsPasswordOk() (*string, bool) {
	if o == nil || IsNil(o.OsPassword) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasOsPassword() bool {
	if o != nil && !IsNil(o.OsPassword) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetOsPassword(v string) {
	o.OsPassword = &v
}

// GetEnvironmentId returns the EnvironmentId field value if set, zero value otherwise.
func (o *ProvisionEmptyVDBParameters) GetEnvironmentId() string {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetEnvironmentIdOk() (*string, bool) {
	if o == nil || IsNil(o.EnvironmentId) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasEnvironmentId() bool {
	if o != nil && !IsNil(o.EnvironmentId) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetEnvironmentId(v string) {
	o.EnvironmentId = &v
}

// GetEnvironmentUserId returns the EnvironmentUserId field value if set, zero value otherwise.
func (o *ProvisionEmptyVDBParameters) GetEnvironmentUserId() string {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetEnvironmentUserIdOk() (*string, bool) {
	if o == nil || IsNil(o.EnvironmentUserId) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasEnvironmentUserId() bool {
	if o != nil && !IsNil(o.EnvironmentUserId) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetEnvironmentUserId(v string) {
	o.EnvironmentUserId = &v
}

// GetRepositoryId returns the RepositoryId field value
func (o *ProvisionEmptyVDBParameters) GetRepositoryId() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetRepositoryIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) SetRepositoryId(v string) {
	o.RepositoryId = v
}

// GetAutoSelectRepository returns the AutoSelectRepository field value if set, zero value otherwise.
func (o *ProvisionEmptyVDBParameters) GetAutoSelectRepository() bool {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetAutoSelectRepositoryOk() (*bool, bool) {
	if o == nil || IsNil(o.AutoSelectRepository) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasAutoSelectRepository() bool {
	if o != nil && !IsNil(o.AutoSelectRepository) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetAutoSelectRepository(v bool) {
	o.AutoSelectRepository = &v
}

// GetVdbRestart returns the VdbRestart field value if set, zero value otherwise.
func (o *ProvisionEmptyVDBParameters) GetVdbRestart() bool {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetVdbRestartOk() (*bool, bool) {
	if o == nil || IsNil(o.VdbRestart) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasVdbRestart() bool {
	if o != nil && !IsNil(o.VdbRestart) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetVdbRestart(v bool) {
	o.VdbRestart = &v
}

// GetTemplateId returns the TemplateId field value if set, zero value otherwise.
func (o *ProvisionEmptyVDBParameters) GetTemplateId() string {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetTemplateIdOk() (*string, bool) {
	if o == nil || IsNil(o.TemplateId) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasTemplateId() bool {
	if o != nil && !IsNil(o.TemplateId) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetTemplateId(v string) {
	o.TemplateId = &v
}

// GetAuxiliaryTemplateId returns the AuxiliaryTemplateId field value if set, zero value otherwise.
func (o *ProvisionEmptyVDBParameters) GetAuxiliaryTemplateId() string {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetAuxiliaryTemplateIdOk() (*string, bool) {
	if o == nil || IsNil(o.AuxiliaryTemplateId) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasAuxiliaryTemplateId() bool {
	if o != nil && !IsNil(o.AuxiliaryTemplateId) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetAuxiliaryTemplateId(v string) {
	o.AuxiliaryTemplateId = &v
}

// GetFileMappingRules returns the FileMappingRules field value if set, zero value otherwise.
func (o *ProvisionEmptyVDBParameters) GetFileMappingRules() string {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetFileMappingRulesOk() (*string, bool) {
	if o == nil || IsNil(o.FileMappingRules) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasFileMappingRules() bool {
	if o != nil && !IsNil(o.FileMappingRules) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetFileMappingRules(v string) {
	o.FileMappingRules = &v
}

// GetOracleInstanceName returns the OracleInstanceName field value if set, zero value otherwise.
func (o *ProvisionEmptyVDBParameters) GetOracleInstanceName() string {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetOracleInstanceNameOk() (*string, bool) {
	if o == nil || IsNil(o.OracleInstanceName) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasOracleInstanceName() bool {
	if o != nil && !IsNil(o.OracleInstanceName) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetOracleInstanceName(v string) {
	o.OracleInstanceName = &v
}

// GetUniqueName returns the UniqueName field value if set, zero value otherwise.
func (o *ProvisionEmptyVDBParameters) GetUniqueName() string {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetUniqueNameOk() (*string, bool) {
	if o == nil || IsNil(o.UniqueName) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasUniqueName() bool {
	if o != nil && !IsNil(o.UniqueName) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetUniqueName(v string) {
	o.UniqueName = &v
}

// GetVcdbName returns the VcdbName field value if set, zero value otherwise.
func (o *ProvisionEmptyVDBParameters) GetVcdbName() string {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetVcdbNameOk() (*string, bool) {
	if o == nil || IsNil(o.VcdbName) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasVcdbName() bool {
	if o != nil && !IsNil(o.VcdbName) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetVcdbName(v string) {
	o.VcdbName = &v
}

// GetVcdbDatabaseName returns the VcdbDatabaseName field value if set, zero value otherwise.
func (o *ProvisionEmptyVDBParameters) GetVcdbDatabaseName() string {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetVcdbDatabaseNameOk() (*string, bool) {
	if o == nil || IsNil(o.VcdbDatabaseName) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasVcdbDatabaseName() bool {
	if o != nil && !IsNil(o.VcdbDatabaseName) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetVcdbDatabaseName(v string) {
	o.VcdbDatabaseName = &v
}

// GetMountPoint returns the MountPoint field value if set, zero value otherwise.
func (o *ProvisionEmptyVDBParameters) GetMountPoint() string {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetMountPointOk() (*string, bool) {
	if o == nil || IsNil(o.MountPoint) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasMountPoint() bool {
	if o != nil && !IsNil(o.MountPoint) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetMountPoint(v string) {
	o.MountPoint = &v
}

// GetOpenResetLogs returns the OpenResetLogs field value if set, zero value otherwise.
func (o *ProvisionEmptyVDBParameters) GetOpenResetLogs() bool {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetOpenResetLogsOk() (*bool, bool) {
	if o == nil || IsNil(o.OpenResetLogs) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasOpenResetLogs() bool {
	if o != nil && !IsNil(o.OpenResetLogs) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetOpenResetLogs(v bool) {
	o.OpenResetLogs = &v
}

// GetSnapshotPolicyId returns the SnapshotPolicyId field value if set, zero value otherwise.
func (o *ProvisionEmptyVDBParameters) GetSnapshotPolicyId() string {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetSnapshotPolicyIdOk() (*string, bool) {
	if o == nil || IsNil(o.SnapshotPolicyId) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasSnapshotPolicyId() bool {
	if o != nil && !IsNil(o.SnapshotPolicyId) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetSnapshotPolicyId(v string) {
	o.SnapshotPolicyId = &v
}

// GetRetentionPolicyId returns the RetentionPolicyId field value if set, zero value otherwise.
func (o *ProvisionEmptyVDBParameters) GetRetentionPolicyId() string {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetRetentionPolicyIdOk() (*string, bool) {
	if o == nil || IsNil(o.RetentionPolicyId) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasRetentionPolicyId() bool {
	if o != nil && !IsNil(o.RetentionPolicyId) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetRetentionPolicyId(v string) {
	o.RetentionPolicyId = &v
}

// GetRecoveryModel returns the RecoveryModel field value if set, zero value otherwise.
func (o *ProvisionEmptyVDBParameters) GetRecoveryModel() string {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetRecoveryModelOk() (*string, bool) {
	if o == nil || IsNil(o.RecoveryModel) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasRecoveryModel() bool {
	if o != nil && !IsNil(o.RecoveryModel) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetRecoveryModel(v string) {
	o.RecoveryModel = &v
}

// GetPreScript returns the PreScript field value if set, zero value otherwise.
func (o *ProvisionEmptyVDBParameters) GetPreScript() string {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetPreScriptOk() (*string, bool) {
	if o == nil || IsNil(o.PreScript) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasPreScript() bool {
	if o != nil && !IsNil(o.PreScript) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetPreScript(v string) {
	o.PreScript = &v
}

// GetPostScript returns the PostScript field value if set, zero value otherwise.
func (o *ProvisionEmptyVDBParameters) GetPostScript() string {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetPostScriptOk() (*string, bool) {
	if o == nil || IsNil(o.PostScript) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasPostScript() bool {
	if o != nil && !IsNil(o.PostScript) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetPostScript(v string) {
	o.PostScript = &v
}

// GetCdcOnProvision returns the CdcOnProvision field value if set, zero value otherwise.
func (o *ProvisionEmptyVDBParameters) GetCdcOnProvision() bool {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetCdcOnProvisionOk() (*bool, bool) {
	if o == nil || IsNil(o.CdcOnProvision) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasCdcOnProvision() bool {
	if o != nil && !IsNil(o.CdcOnProvision) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetCdcOnProvision(v bool) {
	o.CdcOnProvision = &v
}

// GetOnlineLogSize returns the OnlineLogSize field value if set, zero value otherwise.
func (o *ProvisionEmptyVDBParameters) GetOnlineLogSize() int32 {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetOnlineLogSizeOk() (*int32, bool) {
	if o == nil || IsNil(o.OnlineLogSize) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasOnlineLogSize() bool {
	if o != nil && !IsNil(o.OnlineLogSize) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetOnlineLogSize(v int32) {
	o.OnlineLogSize = &v
}

// GetOnlineLogGroups returns the OnlineLogGroups field value if set, zero value otherwise.
func (o *ProvisionEmptyVDBParameters) GetOnlineLogGroups() int32 {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetOnlineLogGroupsOk() (*int32, bool) {
	if o == nil || IsNil(o.OnlineLogGroups) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasOnlineLogGroups() bool {
	if o != nil && !IsNil(o.OnlineLogGroups) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetOnlineLogGroups(v int32) {
	o.OnlineLogGroups = &v
}

// GetArchiveLog returns the ArchiveLog field value if set, zero value otherwise.
func (o *ProvisionEmptyVDBParameters) GetArchiveLog() bool {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetArchiveLogOk() (*bool, bool) {
	if o == nil || IsNil(o.ArchiveLog) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasArchiveLog() bool {
	if o != nil && !IsNil(o.ArchiveLog) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetArchiveLog(v bool) {
	o.ArchiveLog = &v
}

// GetNewDbid returns the NewDbid field value if set, zero value otherwise.
func (o *ProvisionEmptyVDBParameters) GetNewDbid() bool {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetNewDbidOk() (*bool, bool) {
	if o == nil || IsNil(o.NewDbid) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasNewDbid() bool {
	if o != nil && !IsNil(o.NewDbid) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetNewDbid(v bool) {
	o.NewDbid = &v
}

// GetMasked returns the Masked field value if set, zero value otherwise.
func (o *ProvisionEmptyVDBParameters) GetMasked() bool {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetMaskedOk() (*bool, bool) {
	if o == nil || IsNil(o.Masked) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasMasked() bool {
	if o != nil && !IsNil(o.Masked) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetMasked(v bool) {
	o.Masked = &v
}

// GetListenerIds returns the ListenerIds field value if set, zero value otherwise.
func (o *ProvisionEmptyVDBParameters) GetListenerIds() []string {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetListenerIdsOk() ([]string, bool) {
	if o == nil || IsNil(o.ListenerIds) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasListenerIds() bool {
	if o != nil && !IsNil(o.ListenerIds) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetListenerIds(v []string) {
	o.ListenerIds = v
}

// GetCustomEnvVars returns the CustomEnvVars field value if set, zero value otherwise.
func (o *ProvisionEmptyVDBParameters) GetCustomEnvVars() map[string]string {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetCustomEnvVarsOk() (*map[string]string, bool) {
	if o == nil || IsNil(o.CustomEnvVars) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasCustomEnvVars() bool {
	if o != nil && !IsNil(o.CustomEnvVars) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetCustomEnvVars(v map[string]string) {
	o.CustomEnvVars = &v
}

// GetCustomEnvFiles returns the CustomEnvFiles field value if set, zero value otherwise.
func (o *ProvisionEmptyVDBParameters) GetCustomEnvFiles() []string {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetCustomEnvFilesOk() ([]string, bool) {
	if o == nil || IsNil(o.CustomEnvFiles) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasCustomEnvFiles() bool {
	if o != nil && !IsNil(o.CustomEnvFiles) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetCustomEnvFiles(v []string) {
	o.CustomEnvFiles = v
}

// GetOracleRacCustomEnvFiles returns the OracleRacCustomEnvFiles field value if set, zero value otherwise.
func (o *ProvisionEmptyVDBParameters) GetOracleRacCustomEnvFiles() []OracleRacCustomEnvFile {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetOracleRacCustomEnvFilesOk() ([]OracleRacCustomEnvFile, bool) {
	if o == nil || IsNil(o.OracleRacCustomEnvFiles) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasOracleRacCustomEnvFiles() bool {
	if o != nil && !IsNil(o.OracleRacCustomEnvFiles) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetOracleRacCustomEnvFiles(v []OracleRacCustomEnvFile) {
...
func (o *ProvisionEmptyVDBParameters) GetOracleRacCustomEnvVars() []OracleRacCustomEnvVar {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetOracleRacCustomEnvVarsOk() ([]OracleRacCustomEnvVar, bool) {
	if o == nil || IsNil(o.OracleRacCustomEnvVars) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasOracleRacCustomEnvVars() bool {
	if o != nil && !IsNil(o.OracleRacCustomEnvVars) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetOracleRacCustomEnvVars(v []OracleRacCustomEnvVar) {
...
func (o *ProvisionEmptyVDBParameters) GetParentTdeKeystorePath() string {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetParentTdeKeystorePathOk() (*string, bool) {
	if o == nil || IsNil(o.ParentTdeKeystorePath) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasParentTdeKeystorePath() bool {
	if o != nil && !IsNil(o.ParentTdeKeystorePath) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetParentTdeKeystorePath(v string) {
...
func (o *ProvisionEmptyVDBParameters) GetParentTdeKeystorePassword() string {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetParentTdeKeystorePasswordOk() (*string, bool) {
	if o == nil || IsNil(o.ParentTdeKeystorePassword) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasParentTdeKeystorePassword() bool {
	if o != nil && !IsNil(o.ParentTdeKeystorePassword) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetParentTdeKeystorePassword(v string) {
...
func (o *ProvisionEmptyVDBParameters) GetParentPdbTdeKeystorePath() string {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetParentPdbTdeKeystorePathOk() (*string, bool) {
	if o == nil || IsNil(o.ParentPdbTdeKeystorePath) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasParentPdbTdeKeystorePath() bool {
	if o != nil && !IsNil(o.ParentPdbTdeKeystorePath) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetParentPdbTdeKeystorePath(v string) {
...
func (o *ProvisionEmptyVDBParameters) GetParentPdbTdeKeystorePassword() string {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetParentPdbTdeKeystorePasswordOk() (*string, bool) {
	if o == nil || IsNil(o.ParentPdbTdeKeystorePassword) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasParentPdbTdeKeystorePassword() bool {
	if o != nil && !IsNil(o.ParentPdbTdeKeystorePassword) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetParentPdbTdeKeystorePassword(v string) {
...
func (o *ProvisionEmptyVDBParameters) GetTargetPdbTdeKeystorePassword() string {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetTargetPdbTdeKeystorePasswordOk() (*string, bool) {
	if o == nil || IsNil(o.TargetPdbTdeKeystorePassword) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasTargetPdbTdeKeystorePassword() bool {
	if o != nil && !IsNil(o.TargetPdbTdeKeystorePassword) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetTargetPdbTdeKeystorePassword(v string) {
...
func (o *ProvisionEmptyVDBParameters) GetTdeExportedKeyFileSecret() string {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetTdeExportedKeyFileSecretOk() (*string, bool) {
	if o == nil || IsNil(o.TdeExportedKeyFileSecret) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasTdeExportedKeyFileSecret() bool {
	if o != nil && !IsNil(o.TdeExportedKeyFileSecret) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetTdeExportedKeyFileSecret(v string) {
	o.TdeExportedKeyFileSecret = &v
}

// GetTdeKeyIdentifier returns the TdeKeyIdentifier field value if set, zero value otherwise.
func (o *ProvisionEmptyVDBParameters) GetTdeKeyIdentifier() string {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetTdeKeyIdentifierOk() (*string, bool) {
	if o == nil || IsNil(o.TdeKeyIdentifier) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasTdeKeyIdentifier() bool {
	if o != nil && !IsNil(o.TdeKeyIdentifier) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetTdeKeyIdentifier(v string) {
...
func (o *ProvisionEmptyVDBParameters) GetTargetVcdbTdeKeystorePath() string {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetTargetVcdbTdeKeystorePathOk() (*string, bool) {
	if o == nil || IsNil(o.TargetVcdbTdeKeystorePath) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasTargetVcdbTdeKeystorePath() bool {
	if o != nil && !IsNil(o.TargetVcdbTdeKeystorePath) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetTargetVcdbTdeKeystorePath(v string) {
...
func (o *ProvisionEmptyVDBParameters) GetCdbTdeKeystorePassword() string {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetCdbTdeKeystorePasswordOk() (*string, bool) {
	if o == nil || IsNil(o.CdbTdeKeystorePassword) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasCdbTdeKeystorePassword() bool {
	if o != nil && !IsNil(o.CdbTdeKeystorePassword) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetCdbTdeKeystorePassword(v string) {
...
func (o *ProvisionEmptyVDBParameters) GetVcdbTdeKeyIdentifier() string {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetVcdbTdeKeyIdentifierOk() (*string, bool) {
	if o == nil || IsNil(o.VcdbTdeKeyIdentifier) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasVcdbTdeKeyIdentifier() bool {
	if o != nil && !IsNil(o.VcdbTdeKeyIdentifier) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetVcdbTdeKeyIdentifier(v string) {
...
func (o *ProvisionEmptyVDBParameters) GetTdeKeystoreConfigType() OracleTdeKeystoreConfigTypeEnum {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetTdeKeystoreConfigTypeOk() (*OracleTdeKeystoreConfigTypeEnum, bool) {
	if o == nil || IsNil(o.TdeKeystoreConfigType) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasTdeKeystoreConfigType() bool {
	if o != nil && !IsNil(o.TdeKeystoreConfigType) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetTdeKeystoreConfigType(v OracleTdeKeystoreConfigTypeEnum) {
	o.TdeKeystoreConfigType = &v
}

// GetAppdataSourceParams returns the AppdataSourceParams field value if set, zero value otherwise.
func (o *ProvisionEmptyVDBParameters) GetAppdataSourceParams() map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetAppdataSourceParamsOk() (map[string]interface{}, bool) {
	if o == nil || IsNil(o.AppdataSourceParams) {
...
func (o *ProvisionEmptyVDBParameters) HasAppdataSourceParams() bool {
	if o != nil && !IsNil(o.AppdataSourceParams) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetAppdataSourceParams(v map[string]interface{}) {
...
func (o *ProvisionEmptyVDBParameters) GetAdditionalMountPoints() []AdditionalMountPoint {
	if o == nil {
...
func (o *ProvisionEmptyVDBParameters) GetAdditionalMountPointsOk() ([]AdditionalMountPoint, bool) {
...
func (o *ProvisionEmptyVDBParameters) HasAdditionalMountPoints() bool {
	if o != nil && !IsNil(o.AdditionalMountPoints) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetAdditionalMountPoints(v []AdditionalMountPoint) {
...
func (o *ProvisionEmptyVDBParameters) GetAppdataConfigParams() map[string]interface{} {
	if o == nil {
		var ret map[string]interface{}
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ProvisionEmptyVDBParameters) GetAppdataConfigParamsOk() (map[string]interface{}, bool) {
...
func (o *ProvisionEmptyVDBParameters) HasAppdataConfigParams() bool {
	if o != nil && !IsNil(o.AppdataConfigParams) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetAppdataConfigParams(v map[string]interface{}) {
...
func (o *ProvisionEmptyVDBParameters) GetConfigParams() map[string]interface{} {
	if o == nil {
		var ret map[string]interface{}
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ProvisionEmptyVDBParameters) GetConfigParamsOk() (map[string]interface{}, bool) {
...
func (o *ProvisionEmptyVDBParameters) HasConfigParams() bool {
	if o != nil && !IsNil(o.ConfigParams) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetConfigParams(v map[string]interface{}) {
	o.ConfigParams = v
}

// GetPrivilegedOsUser returns the PrivilegedOsUser field value if set, zero value otherwise.
func (o *ProvisionEmptyVDBParameters) GetPrivilegedOsUser() string {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetPrivilegedOsUserOk() (*string, bool) {
	if o == nil || IsNil(o.PrivilegedOsUser) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasPrivilegedOsUser() bool {
	if o != nil && !IsNil(o.PrivilegedOsUser) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetPrivilegedOsUser(v string) {
	o.PrivilegedOsUser = &v
}

// GetPostgresPort returns the PostgresPort field value if set, zero value otherwise.
func (o *ProvisionEmptyVDBParameters) GetPostgresPort() int32 {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetPostgresPortOk() (*int32, bool) {
	if o == nil || IsNil(o.PostgresPort) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasPostgresPort() bool {
	if o != nil && !IsNil(o.PostgresPort) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetPostgresPort(v int32) {
	o.PostgresPort = &v
}

// GetConfigSettingsStg returns the ConfigSettingsStg field value if set, zero value otherwise.
func (o *ProvisionEmptyVDBParameters) GetConfigSettingsStg() []ConfigSettingsStg {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetConfigSettingsStgOk() ([]ConfigSettingsStg, bool) {
	if o == nil || IsNil(o.ConfigSettingsStg) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasConfigSettingsStg() bool {
	if o != nil && !IsNil(o.ConfigSettingsStg) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetConfigSettingsStg(v []ConfigSettingsStg) {
	o.ConfigSettingsStg = v
}

// GetVcdbRestart returns the VcdbRestart field value if set, zero value otherwise.
func (o *ProvisionEmptyVDBParameters) GetVcdbRestart() bool {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetVcdbRestartOk() (*bool, bool) {
	if o == nil || IsNil(o.VcdbRestart) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasVcdbRestart() bool {
	if o != nil && !IsNil(o.VcdbRestart) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetVcdbRestart(v bool) {
	o.VcdbRestart = &v
}

// GetMssqlFailoverDriveLetter returns the MssqlFailoverDriveLetter field value if set, zero value otherwise.
func (o *ProvisionEmptyVDBParameters) GetMssqlFailoverDriveLetter() string {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetMssqlFailoverDriveLetterOk() (*string, bool) {
	if o == nil || IsNil(o.MssqlFailoverDriveLetter) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasMssqlFailoverDriveLetter() bool {
	if o != nil && !IsNil(o.MssqlFailoverDriveLetter) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetMssqlFailoverDriveLetter(v string) {
	o.MssqlFailoverDriveLetter = &v
}

// GetTags returns the Tags field value if set, zero value otherwise.
func (o *ProvisionEmptyVDBParameters) GetTags() []Tag {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetTagsOk() ([]Tag, bool) {
	if o == nil || IsNil(o.Tags) {
		return nil, false
	}
	return o.Tags, true
...
func (o *ProvisionEmptyVDBParameters) HasTags() bool {
	if o != nil && !IsNil(o.Tags) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetTags(v []Tag) {
	o.Tags = v
}

// GetInvokeDatapatch returns the InvokeDatapatch field value if set, zero value otherwise.
func (o *ProvisionEmptyVDBParameters) GetInvokeDatapatch() bool {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetInvokeDatapatchOk() (*bool, bool) {
	if o == nil || IsNil(o.InvokeDatapatch) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasInvokeDatapatch() bool {
	if o != nil && !IsNil(o.InvokeDatapatch) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetInvokeDatapatch(v bool) {
	o.InvokeDatapatch = &v
}

// GetContainerMode returns the ContainerMode field value if set, zero value otherwise.
func (o *ProvisionEmptyVDBParameters) GetContainerMode() bool {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetContainerModeOk() (*bool, bool) {
	if o == nil || IsNil(o.ContainerMode) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasContainerMode() bool {
	if o != nil && !IsNil(o.ContainerMode) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetContainerMode(v bool) {
	o.ContainerMode = &v
}

// GetMssqlAgBackupLocation returns the MssqlAgBackupLocation field value if set, zero value otherwise.
func (o *ProvisionEmptyVDBParameters) GetMssqlAgBackupLocation() string {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetMssqlAgBackupLocationOk() (*string, bool) {
	if o == nil || IsNil(o.MssqlAgBackupLocation) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasMssqlAgBackupLocation() bool {
	if o != nil && !IsNil(o.MssqlAgBackupLocation) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetMssqlAgBackupLocation(v string) {
	o.MssqlAgBackupLocation = &v
}

// GetMssqlAgBackupBased returns the MssqlAgBackupBased field value if set, zero value otherwise.
func (o *ProvisionEmptyVDBParameters) GetMssqlAgBackupBased() bool {
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetMssqlAgBackupBasedOk() (*bool, bool) {
	if o == nil || IsNil(o.MssqlAgBackupBased) {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) HasMssqlAgBackupBased() bool {
	if o != nil && !IsNil(o.MssqlAgBackupBased) {
		return true
	}
...
func (o *ProvisionEmptyVDBParameters) SetMssqlAgBackupBased(v bool) {
	o.MssqlAgBackupBased = &v
}

// GetEngineId returns the EngineId field value
func (o *ProvisionEmptyVDBParameters) GetEngineId() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ProvisionEmptyVDBParameters) GetEngineIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ProvisionEmptyVDBParameters) SetEngineId(v string) {
	o.EngineId = v
}

func (o ProvisionEmptyVDBParameters) MarshalJSON() ([]byte, error) {
...
func (o ProvisionEmptyVDBParameters) ToMap() (map[string]interface{}, error) {
...
func (o *ProvisionEmptyVDBParameters) UnmarshalJSON(data []byte) (err error) {
	...
	varProvisionEmptyVDBParameters := _ProvisionEmptyVDBParameters{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varProvisionEmptyVDBParameters)

	if err != nil {
		return err
	}

	*o = ProvisionEmptyVDBParameters(varProvisionEmptyVDBParameters)

	return err
}

type NullableProvisionEmptyVDBParameters struct {
	value *ProvisionEmptyVDBParameters
	isSet bool
}

func (v NullableProvisionEmptyVDBParameters) Get() *ProvisionEmptyVDBParameters {
	return v.value
}

func (v *NullableProvisionEmptyVDBParameters) Set(val *ProvisionEmptyVDBParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableProvisionEmptyVDBParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableProvisionEmptyVDBParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProvisionEmptyVDBParameters(val *ProvisionEmptyVDBParameters) *NullableProvisionEmptyVDBParameters {
	return &NullableProvisionEmptyVDBParameters{value: val, isSet: true}
}

func (v NullableProvisionEmptyVDBParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProvisionEmptyVDBParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
