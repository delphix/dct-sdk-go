...
// checks if the OracleAttachParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OracleAttachParameters{}

// OracleAttachParameters struct for OracleAttachParameters
type OracleAttachParameters struct {
...
// NewOracleAttachParameters instantiates a new OracleAttachParameters object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewOracleAttachParameters() *OracleAttachParameters {
	this := OracleAttachParameters{}
...
// NewOracleAttachParametersWithDefaults instantiates a new OracleAttachParameters object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewOracleAttachParametersWithDefaults() *OracleAttachParameters {
	this := OracleAttachParameters{}
	var bandwidthLimit int32 = 0
	this.BandwidthLimit = &bandwidthLimit
	var checkLogical bool = false
...
func (o *OracleAttachParameters) GetBackupLevelEnabled() bool {
...
func (o *OracleAttachParameters) GetBackupLevelEnabledOk() (*bool, bool) {
	if o == nil || IsNil(o.BackupLevelEnabled) {
		return nil, false
	}
...
func (o *OracleAttachParameters) HasBackupLevelEnabled() bool {
	if o != nil && !IsNil(o.BackupLevelEnabled) {
		return true
	}
...
func (o *OracleAttachParameters) SetBackupLevelEnabled(v bool) {
	o.BackupLevelEnabled = &v
}

// GetBandwidthLimit returns the BandwidthLimit field value if set, zero value otherwise.
func (o *OracleAttachParameters) GetBandwidthLimit() int32 {
...
// and a boolean to check if the value has been set.
func (o *OracleAttachParameters) GetBandwidthLimitOk() (*int32, bool) {
	if o == nil || IsNil(o.BandwidthLimit) {
		return nil, false
	}
...
func (o *OracleAttachParameters) HasBandwidthLimit() bool {
	if o != nil && !IsNil(o.BandwidthLimit) {
		return true
	}
...
func (o *OracleAttachParameters) SetBandwidthLimit(v int32) {
	o.BandwidthLimit = &v
}

// GetCheckLogical returns the CheckLogical field value if set, zero value otherwise.
func (o *OracleAttachParameters) GetCheckLogical() bool {
...
// and a boolean to check if the value has been set.
func (o *OracleAttachParameters) GetCheckLogicalOk() (*bool, bool) {
	if o == nil || IsNil(o.CheckLogical) {
		return nil, false
	}
...
func (o *OracleAttachParameters) HasCheckLogical() bool {
	if o != nil && !IsNil(o.CheckLogical) {
		return true
	}
...
func (o *OracleAttachParameters) SetCheckLogical(v bool) {
	o.CheckLogical = &v
}

// GetCompressedLinkingEnabled returns the CompressedLinkingEnabled field value if set, zero value otherwise.
func (o *OracleAttachParameters) GetCompressedLinkingEnabled() bool {
...
// and a boolean to check if the value has been set.
func (o *OracleAttachParameters) GetCompressedLinkingEnabledOk() (*bool, bool) {
	if o == nil || IsNil(o.CompressedLinkingEnabled) {
		return nil, false
	}
...
func (o *OracleAttachParameters) HasCompressedLinkingEnabled() bool {
	if o != nil && !IsNil(o.CompressedLinkingEnabled) {
		return true
	}
...
func (o *OracleAttachParameters) SetCompressedLinkingEnabled(v bool) {
	o.CompressedLinkingEnabled = &v
}

// GetDoubleSync returns the DoubleSync field value if set, zero value otherwise.
func (o *OracleAttachParameters) GetDoubleSync() bool {
...
// and a boolean to check if the value has been set.
func (o *OracleAttachParameters) GetDoubleSyncOk() (*bool, bool) {
	if o == nil || IsNil(o.DoubleSync) {
		return nil, false
	}
...
func (o *OracleAttachParameters) HasDoubleSync() bool {
	if o != nil && !IsNil(o.DoubleSync) {
		return true
	}
...
func (o *OracleAttachParameters) SetDoubleSync(v bool) {
	o.DoubleSync = &v
}

// GetEncryptedLinkingEnabled returns the EncryptedLinkingEnabled field value if set, zero value otherwise.
func (o *OracleAttachParameters) GetEncryptedLinkingEnabled() bool {
...
// and a boolean to check if the value has been set.
func (o *OracleAttachParameters) GetEncryptedLinkingEnabledOk() (*bool, bool) {
	if o == nil || IsNil(o.EncryptedLinkingEnabled) {
		return nil, false
	}
...
func (o *OracleAttachParameters) HasEncryptedLinkingEnabled() bool {
	if o != nil && !IsNil(o.EncryptedLinkingEnabled) {
		return true
	}
...
func (o *OracleAttachParameters) SetEncryptedLinkingEnabled(v bool) {
	o.EncryptedLinkingEnabled = &v
}

// GetEnvironmentUser returns the EnvironmentUser field value if set, zero value otherwise.
func (o *OracleAttachParameters) GetEnvironmentUser() string {
...
// and a boolean to check if the value has been set.
func (o *OracleAttachParameters) GetEnvironmentUserOk() (*string, bool) {
	if o == nil || IsNil(o.EnvironmentUser) {
		return nil, false
	}
...
func (o *OracleAttachParameters) HasEnvironmentUser() bool {
	if o != nil && !IsNil(o.EnvironmentUser) {
		return true
	}
...
func (o *OracleAttachParameters) SetEnvironmentUser(v string) {
	o.EnvironmentUser = &v
}

// GetExternalFilePath returns the ExternalFilePath field value if set, zero value otherwise.
func (o *OracleAttachParameters) GetExternalFilePath() string {
...
// and a boolean to check if the value has been set.
func (o *OracleAttachParameters) GetExternalFilePathOk() (*string, bool) {
	if o == nil || IsNil(o.ExternalFilePath) {
		return nil, false
	}
...
func (o *OracleAttachParameters) HasExternalFilePath() bool {
	if o != nil && !IsNil(o.ExternalFilePath) {
		return true
	}
...
func (o *OracleAttachParameters) SetExternalFilePath(v string) {
	o.ExternalFilePath = &v
}

// GetFilesPerSet returns the FilesPerSet field value if set, zero value otherwise.
func (o *OracleAttachParameters) GetFilesPerSet() int32 {
...
// and a boolean to check if the value has been set.
func (o *OracleAttachParameters) GetFilesPerSetOk() (*int32, bool) {
	if o == nil || IsNil(o.FilesPerSet) {
		return nil, false
	}
...
func (o *OracleAttachParameters) HasFilesPerSet() bool {
	if o != nil && !IsNil(o.FilesPerSet) {
		return true
	}
...
func (o *OracleAttachParameters) SetFilesPerSet(v int32) {
	o.FilesPerSet = &v
}

// GetForce returns the Force field value if set, zero value otherwise.
func (o *OracleAttachParameters) GetForce() bool {
...
// and a boolean to check if the value has been set.
func (o *OracleAttachParameters) GetForceOk() (*bool, bool) {
	if o == nil || IsNil(o.Force) {
		return nil, false
	}
	return o.Force, true
...
func (o *OracleAttachParameters) HasForce() bool {
	if o != nil && !IsNil(o.Force) {
		return true
	}
...
func (o *OracleAttachParameters) SetForce(v bool) {
	o.Force = &v
}

// GetLinkNow returns the LinkNow field value if set, zero value otherwise.
func (o *OracleAttachParameters) GetLinkNow() bool {
...
// and a boolean to check if the value has been set.
func (o *OracleAttachParameters) GetLinkNowOk() (*bool, bool) {
	if o == nil || IsNil(o.LinkNow) {
		return nil, false
	}
...
func (o *OracleAttachParameters) HasLinkNow() bool {
	if o != nil && !IsNil(o.LinkNow) {
		return true
	}
...
func (o *OracleAttachParameters) SetLinkNow(v bool) {
	o.LinkNow = &v
}

// GetNumberOfConnections returns the NumberOfConnections field value if set, zero value otherwise.
func (o *OracleAttachParameters) GetNumberOfConnections() int32 {
...
// and a boolean to check if the value has been set.
func (o *OracleAttachParameters) GetNumberOfConnectionsOk() (*int32, bool) {
	if o == nil || IsNil(o.NumberOfConnections) {
		return nil, false
	}
...
func (o *OracleAttachParameters) HasNumberOfConnections() bool {
	if o != nil && !IsNil(o.NumberOfConnections) {
		return true
	}
...
func (o *OracleAttachParameters) SetNumberOfConnections(v int32) {
	o.NumberOfConnections = &v
}

// GetOperations returns the Operations field value if set, zero value otherwise.
func (o *OracleAttachParameters) GetOperations() []SourceOperation {
...
// and a boolean to check if the value has been set.
func (o *OracleAttachParameters) GetOperationsOk() ([]SourceOperation, bool) {
	if o == nil || IsNil(o.Operations) {
		return nil, false
	}
...
func (o *OracleAttachParameters) HasOperations() bool {
	if o != nil && !IsNil(o.Operations) {
		return true
	}
...
func (o *OracleAttachParameters) SetOperations(v []SourceOperation) {
	o.Operations = v
}

// GetOracleFallbackUser returns the OracleFallbackUser field value if set, zero value otherwise.
func (o *OracleAttachParameters) GetOracleFallbackUser() string {
...
// and a boolean to check if the value has been set.
func (o *OracleAttachParameters) GetOracleFallbackUserOk() (*string, bool) {
	if o == nil || IsNil(o.OracleFallbackUser) {
		return nil, false
	}
...
func (o *OracleAttachParameters) HasOracleFallbackUser() bool {
	if o != nil && !IsNil(o.OracleFallbackUser) {
		return true
	}
...
func (o *OracleAttachParameters) SetOracleFallbackUser(v string) {
...
func (o *OracleAttachParameters) GetOracleFallbackCredentials() string {
...
// and a boolean to check if the value has been set.
func (o *OracleAttachParameters) GetOracleFallbackCredentialsOk() (*string, bool) {
	if o == nil || IsNil(o.OracleFallbackCredentials) {
		return nil, false
	}
...
func (o *OracleAttachParameters) HasOracleFallbackCredentials() bool {
	if o != nil && !IsNil(o.OracleFallbackCredentials) {
		return true
	}
...
func (o *OracleAttachParameters) SetOracleFallbackCredentials(v string) {
	o.OracleFallbackCredentials = &v
}

// GetRmanChannels returns the RmanChannels field value if set, zero value otherwise.
func (o *OracleAttachParameters) GetRmanChannels() int32 {
...
// and a boolean to check if the value has been set.
func (o *OracleAttachParameters) GetRmanChannelsOk() (*int32, bool) {
	if o == nil || IsNil(o.RmanChannels) {
		return nil, false
	}
...
func (o *OracleAttachParameters) HasRmanChannels() bool {
	if o != nil && !IsNil(o.RmanChannels) {
		return true
	}
...
func (o *OracleAttachParameters) SetRmanChannels(v int32) {
	o.RmanChannels = &v
}

func (o OracleAttachParameters) MarshalJSON() ([]byte, error) {
...
func (o OracleAttachParameters) ToMap() (map[string]interface{}, error) {
...
type NullableOracleAttachParameters struct {
	value *OracleAttachParameters
	isSet bool
}

func (v NullableOracleAttachParameters) Get() *OracleAttachParameters {
	return v.value
}

func (v *NullableOracleAttachParameters) Set(val *OracleAttachParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableOracleAttachParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableOracleAttachParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOracleAttachParameters(val *OracleAttachParameters) *NullableOracleAttachParameters {
	return &NullableOracleAttachParameters{value: val, isSet: true}
}

func (v NullableOracleAttachParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOracleAttachParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
