...
// checks if the ListTimeflowsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListTimeflowsResponse{}
...
type NullableListTimeflowsResponse struct {
	value *ListTimeflowsResponse
	isSet bool
}

func (v NullableListTimeflowsResponse) Get() *ListTimeflowsResponse {
	return v.value
}

func (v *NullableListTimeflowsResponse) Set(val *ListTimeflowsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListTimeflowsResponse) IsSet() bool {
	return v.isSet
}
...
func NewNullableListTimeflowsResponse(val *ListTimeflowsResponse) *NullableListTimeflowsResponse {
	return &NullableListTimeflowsResponse{value: val, isSet: true}
}
