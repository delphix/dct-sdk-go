...
// checks if the SearchExecutionsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SearchExecutionsResponse{}
...
type NullableSearchExecutionsResponse struct {
	value *SearchExecutionsResponse
	isSet bool
}

func (v NullableSearchExecutionsResponse) Get() *SearchExecutionsResponse {
	return v.value
}

func (v *NullableSearchExecutionsResponse) Set(val *SearchExecutionsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableSearchExecutionsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableSearchExecutionsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSearchExecutionsResponse(val *SearchExecutionsResponse) *NullableSearchExecutionsResponse {
	return &NullableSearchExecutionsResponse{value: val, isSet: true}
}
