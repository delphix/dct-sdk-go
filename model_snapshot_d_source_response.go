...
// checks if the SnapshotDSourceResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SnapshotDSourceResponse{}
...
type NullableSnapshotDSourceResponse struct {
	value *SnapshotDSourceResponse
	isSet bool
}

func (v NullableSnapshotDSourceResponse) Get() *SnapshotDSourceResponse {
	return v.value
}

func (v *NullableSnapshotDSourceResponse) Set(val *SnapshotDSourceResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableSnapshotDSourceResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableSnapshotDSourceResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSnapshotDSourceResponse(val *SnapshotDSourceResponse) *NullableSnapshotDSourceResponse {
	return &NullableSnapshotDSourceResponse{value: val, isSet: true}
}
