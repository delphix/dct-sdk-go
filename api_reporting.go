...
type ApiDownloadExecutionPdfReportRequest struct {
	ctx context.Context
	ApiService *ReportingAPIService
	executionId string
}

func (r ApiDownloadExecutionPdfReportRequest) Execute() (*os.File, *http.Response, error) {
	return r.ApiService.DownloadExecutionPdfReportExecute(r)
}

/*
DownloadExecutionPdfReport Download PDF report for given execution.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param executionId The ID of the Execution.
 @return ApiDownloadExecutionPdfReportRequest
*/
func (a *ReportingAPIService) DownloadExecutionPdfReport(ctx context.Context, executionId string) ApiDownloadExecutionPdfReportRequest {
	return ApiDownloadExecutionPdfReportRequest{
		ApiService: a,
		ctx: ctx,
...
// Execute executes the request
//  @return *os.File
func (a *ReportingAPIService) DownloadExecutionPdfReportExecute(r ApiDownloadExecutionPdfReportRequest) (*os.File, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ReportingAPIService.DownloadExecutionPdfReport")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/reporting/{executionId}/download-pdf-report"
...
type ApiGenerateExecutionPdfReportRequest struct {
	ctx context.Context
	ApiService *ReportingAPIService
	executionId string
}

func (r ApiGenerateExecutionPdfReportRequest) Execute() (*GenerateExecutionPdfReportResponse, *http.Response, error) {
	return r.ApiService.GenerateExecutionPdfReportExecute(r)
}

/*
GenerateExecutionPdfReport Generate a PDF report for given execution.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param executionId The ID of the Execution.
 @return ApiGenerateExecutionPdfReportRequest
*/
func (a *ReportingAPIService) GenerateExecutionPdfReport(ctx context.Context, executionId string) ApiGenerateExecutionPdfReportRequest {
	return ApiGenerateExecutionPdfReportRequest{
		ApiService: a,
		ctx: ctx,
		executionId: executionId,
...
// Execute executes the request
//  @return GenerateExecutionPdfReportResponse
func (a *ReportingAPIService) GenerateExecutionPdfReportExecute(r ApiGenerateExecutionPdfReportRequest) (*GenerateExecutionPdfReportResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GenerateExecutionPdfReportResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ReportingAPIService.GenerateExecutionPdfReport")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/reporting/{executionId}/generate-pdf-report"
	localVarPath = strings.Replace(localVarPath, "{"+"executionId"+"}", url.PathEscape(parameterValueToString(r.executionId, "executionId")), -1)
...
type ApiGetDatasetPerformanceAnalyticsRequest struct {
	ctx context.Context
	ApiService *ReportingAPIService
	datasetPerformanceAnalyticsRequest *DatasetPerformanceAnalyticsRequest
}

func (r ApiGetDatasetPerformanceAnalyticsRequest) DatasetPerformanceAnalyticsRequest(datasetPerformanceAnalyticsRequest DatasetPerformanceAnalyticsRequest) ApiGetDatasetPerformanceAnalyticsRequest {
	r.datasetPerformanceAnalyticsRequest = &datasetPerformanceAnalyticsRequest
	return r
}

func (r ApiGetDatasetPerformanceAnalyticsRequest) Execute() (*DatasetPerformanceAnalyticsResponse, *http.Response, error) {
	return r.ApiService.GetDatasetPerformanceAnalyticsExecute(r)
}

/*
GetDatasetPerformanceAnalytics Get Dataset Performance analytics

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetDatasetPerformanceAnalyticsRequest
*/
func (a *ReportingAPIService) GetDatasetPerformanceAnalytics(ctx context.Context) ApiGetDatasetPerformanceAnalyticsRequest {
	return ApiGetDatasetPerformanceAnalyticsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return DatasetPerformanceAnalyticsResponse
func (a *ReportingAPIService) GetDatasetPerformanceAnalyticsExecute(r ApiGetDatasetPerformanceAnalyticsRequest) (*DatasetPerformanceAnalyticsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *DatasetPerformanceAnalyticsResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ReportingAPIService.GetDatasetPerformanceAnalytics")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/reporting/dataset-performance-analytics"
	...
	// body params
	localVarPostBody = r.datasetPerformanceAnalyticsRequest
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["ApiKeyAuth"]; ok {
...
type ApiGetStorageCapacityDataRequest struct {
	ctx context.Context
	ApiService *ReportingAPIService
	engineId *string
	limit *int32
...
func (r ApiGetStorageCapacityDataRequest) EngineId(engineId string) ApiGetStorageCapacityDataRequest {
	r.engineId = &engineId
	return r
}

// Maximum number of objects to return per query. The value must be between 1 and 1000. Default is 100.
func (r ApiGetStorageCapacityDataRequest) Limit(limit int32) ApiGetStorageCapacityDataRequest {
	r.limit = &limit
	return r
}

// Cursor to fetch the next or previous page of results. The value of this property must be extracted from the &#39;prev_cursor&#39; or &#39;next_cursor&#39; property of a PaginatedResponseMetadata which is contained in the response of list and search API endpoints.
func (r ApiGetStorageCapacityDataRequest) Cursor(cursor string) ApiGetStorageCapacityDataRequest {
	r.cursor = &cursor
	return r
}

// The field to sort results by. A property name with a prepended &#39;-&#39; signifies descending order.
func (r ApiGetStorageCapacityDataRequest) Sort(sort string) ApiGetStorageCapacityDataRequest {
	r.sort = &sort
	return r
}

func (r ApiGetStorageCapacityDataRequest) Execute() (*EngineStorageCapacityDataResponse, *http.Response, error) {
	return r.ApiService.GetStorageCapacityDataExecute(r)
}

/*
GetStorageCapacityData Get engine storage capacity data.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetStorageCapacityDataRequest
*/
func (a *ReportingAPIService) GetStorageCapacityData(ctx context.Context) ApiGetStorageCapacityDataRequest {
	return ApiGetStorageCapacityDataRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return EngineStorageCapacityDataResponse
func (a *ReportingAPIService) GetStorageCapacityDataExecute(r ApiGetStorageCapacityDataRequest) (*EngineStorageCapacityDataResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *EngineStorageCapacityDataResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ReportingAPIService.GetStorageCapacityData")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/reporting/storage-capacity-data-report"
	...
	if r.engineId != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "engine_id", r.engineId, "form", "")
	}
	if r.limit != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "limit", r.limit, "form", "")
	} else {
...
type ApiSearchDatasetPerformanceAnalyticsSummaryRequest struct {
	ctx context.Context
	ApiService *ReportingAPIService
	engineId *string
	limit *int32
...
// ID of a registered engine.
func (r ApiSearchDatasetPerformanceAnalyticsSummaryRequest) EngineId(engineId string) ApiSearchDatasetPerformanceAnalyticsSummaryRequest {
	r.engineId = &engineId
	return r
}

// Maximum number of objects to return per query. The value must be between 1 and 1000. Default is 100.
func (r ApiSearchDatasetPerformanceAnalyticsSummaryRequest) Limit(limit int32) ApiSearchDatasetPerformanceAnalyticsSummaryRequest {
	r.limit = &limit
	return r
}

// Cursor to fetch the next or previous page of results. The value of this property must be extracted from the &#39;prev_cursor&#39; or &#39;next_cursor&#39; property of a PaginatedResponseMetadata which is contained in the response of list and search API endpoints.
func (r ApiSearchDatasetPerformanceAnalyticsSummaryRequest) Cursor(cursor string) ApiSearchDatasetPerformanceAnalyticsSummaryRequest {
	r.cursor = &cursor
	return r
}

// The field to sort results by. A property name with a prepended &#39;-&#39; signifies descending order.
func (r ApiSearchDatasetPerformanceAnalyticsSummaryRequest) Sort(sort string) ApiSearchDatasetPerformanceAnalyticsSummaryRequest {
	r.sort = &sort
	return r
}

// A request body containing a filter expression. This enables searching for items matching arbitrarily complex conditions. The list of attributes which can be used in filter expressions is available in the x-filterable vendor extension.  # Filter Expression Overview **Note: All keywords are case-insensitive**  ## Comparison Operators | Operator | Description | Example | | --- | --- | --- | | CONTAINS | Substring or membership testing for string and list attributes respectively. | field3 CONTAINS &#39;foobar&#39;, field4 CONTAINS TRUE  | | IN | Tests if field is a member of a list literal. List can contain a maximum of 100 values | field2 IN [&#39;Goku&#39;, &#39;Vegeta&#39;] | | GE | Tests if a field is greater than or equal to a literal value | field1 GE 1.2e-2 | | GT | Tests if a field is greater than a literal value | field1 GT 1.2e-2 | | LE | Tests if a field is less than or equal to a literal value | field1 LE 9000 | | LT | Tests if a field is less than a literal value | field1 LT 9.02 | | NE | Tests if a field is not equal to a literal value | field1 NE 42 | | EQ | Tests if a field is equal to a literal value | field1 EQ 42 |  ## Search Operator The SEARCH operator filters for items which have any filterable attribute that contains the input string as a substring, comparison is done case-insensitively. This is not restricted to attributes with string values. Specifically &#x60;SEARCH &#39;12&#39;&#x60; would match an item with an attribute with an integer value of &#x60;123&#x60;.  ## Logical Operators Ordered by precedence. | Operator | Description | Example | | --- | --- | --- | | NOT | Logical NOT (Right associative) | NOT field1 LE 9000 | | AND | Logical AND (Left Associative) | field1 GT 9000 AND field2 EQ &#39;Goku&#39; | | OR | Logical OR (Left Associative) | field1 GT 9000 OR field2 EQ &#39;Goku&#39; |  ## Grouping Parenthesis &#x60;()&#x60; can be used to override operator precedence.  For example: NOT (field1 LT 1234 AND field2 CONTAINS &#39;foo&#39;)  ## Literal Values | Literal      | Description | Examples | | --- | --- | --- | | Nil | Represents the absence of a value | nil, Nil, nIl, NIL | | Boolean | true/false boolean | true, false, True, False, TRUE, FALSE | | Number | Signed integer and floating point numbers. Also supports scientific notation. | 0, 1, -1, 1.2, 0.35, 1.2e-2, -1.2e+2 | | String | Single or double quoted | \&quot;foo\&quot;, \&quot;bar\&quot;, \&quot;foo bar\&quot;, &#39;foo&#39;, &#39;bar&#39;, &#39;foo bar&#39; | | Datetime | Formatted according to [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339) | 2018-04-27T18:39:26.397237+00:00 | | List | Comma-separated literals wrapped in square brackets | [0], [0, 1], [&#39;foo&#39;, \&quot;bar\&quot;] |  ## Limitations - A maximum of 8 unique identifiers may be used inside a filter expression. 
func (r ApiSearchDatasetPerformanceAnalyticsSummaryRequest) SearchBody(searchBody SearchBody) ApiSearchDatasetPerformanceAnalyticsSummaryRequest {
	r.searchBody = &searchBody
	return r
}

func (r ApiSearchDatasetPerformanceAnalyticsSummaryRequest) Execute() (*DatasetPerformanceAnalyticsSummaryResponse, *http.Response, error) {
	return r.ApiService.SearchDatasetPerformanceAnalyticsSummaryExecute(r)
}

/*
SearchDatasetPerformanceAnalyticsSummary Search Dataset Performance analytics summary

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiSearchDatasetPerformanceAnalyticsSummaryRequest
*/
func (a *ReportingAPIService) SearchDatasetPerformanceAnalyticsSummary(ctx context.Context) ApiSearchDatasetPerformanceAnalyticsSummaryRequest {
	return ApiSearchDatasetPerformanceAnalyticsSummaryRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return DatasetPerformanceAnalyticsSummaryResponse
func (a *ReportingAPIService) SearchDatasetPerformanceAnalyticsSummaryExecute(r ApiSearchDatasetPerformanceAnalyticsSummaryRequest) (*DatasetPerformanceAnalyticsSummaryResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *DatasetPerformanceAnalyticsSummaryResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ReportingAPIService.SearchDatasetPerformanceAnalyticsSummary")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/reporting/dataset-performance-analytics-summary/search"
...
type ApiSearchStorageCapacityDataRequest struct {
	ctx context.Context
	ApiService *ReportingAPIService
	engineId *string
	limit *int32
...
// ID of a registered engine.
func (r ApiSearchStorageCapacityDataRequest) EngineId(engineId string) ApiSearchStorageCapacityDataRequest {
	r.engineId = &engineId
	return r
}

// Maximum number of objects to return per query. The value must be between 1 and 1000. Default is 100.
func (r ApiSearchStorageCapacityDataRequest) Limit(limit int32) ApiSearchStorageCapacityDataRequest {
	r.limit = &limit
	return r
}

// Cursor to fetch the next or previous page of results. The value of this property must be extracted from the &#39;prev_cursor&#39; or &#39;next_cursor&#39; property of a PaginatedResponseMetadata which is contained in the response of list and search API endpoints.
func (r ApiSearchStorageCapacityDataRequest) Cursor(cursor string) ApiSearchStorageCapacityDataRequest {
	r.cursor = &cursor
	return r
}

// The field to sort results by. A property name with a prepended &#39;-&#39; signifies descending order.
func (r ApiSearchStorageCapacityDataRequest) Sort(sort string) ApiSearchStorageCapacityDataRequest {
	r.sort = &sort
	return r
}

// A request body containing a filter expression. This enables searching for items matching arbitrarily complex conditions. The list of attributes which can be used in filter expressions is available in the x-filterable vendor extension.  # Filter Expression Overview **Note: All keywords are case-insensitive**  ## Comparison Operators | Operator | Description | Example | | --- | --- | --- | | CONTAINS | Substring or membership testing for string and list attributes respectively. | field3 CONTAINS &#39;foobar&#39;, field4 CONTAINS TRUE  | | IN | Tests if field is a member of a list literal. List can contain a maximum of 100 values | field2 IN [&#39;Goku&#39;, &#39;Vegeta&#39;] | | GE | Tests if a field is greater than or equal to a literal value | field1 GE 1.2e-2 | | GT | Tests if a field is greater than a literal value | field1 GT 1.2e-2 | | LE | Tests if a field is less than or equal to a literal value | field1 LE 9000 | | LT | Tests if a field is less than a literal value | field1 LT 9.02 | | NE | Tests if a field is not equal to a literal value | field1 NE 42 | | EQ | Tests if a field is equal to a literal value | field1 EQ 42 |  ## Search Operator The SEARCH operator filters for items which have any filterable attribute that contains the input string as a substring, comparison is done case-insensitively. This is not restricted to attributes with string values. Specifically &#x60;SEARCH &#39;12&#39;&#x60; would match an item with an attribute with an integer value of &#x60;123&#x60;.  ## Logical Operators Ordered by precedence. | Operator | Description | Example | | --- | --- | --- | | NOT | Logical NOT (Right associative) | NOT field1 LE 9000 | | AND | Logical AND (Left Associative) | field1 GT 9000 AND field2 EQ &#39;Goku&#39; | | OR | Logical OR (Left Associative) | field1 GT 9000 OR field2 EQ &#39;Goku&#39; |  ## Grouping Parenthesis &#x60;()&#x60; can be used to override operator precedence.  For example: NOT (field1 LT 1234 AND field2 CONTAINS &#39;foo&#39;)  ## Literal Values | Literal      | Description | Examples | | --- | --- | --- | | Nil | Represents the absence of a value | nil, Nil, nIl, NIL | | Boolean | true/false boolean | true, false, True, False, TRUE, FALSE | | Number | Signed integer and floating point numbers. Also supports scientific notation. | 0, 1, -1, 1.2, 0.35, 1.2e-2, -1.2e+2 | | String | Single or double quoted | \&quot;foo\&quot;, \&quot;bar\&quot;, \&quot;foo bar\&quot;, &#39;foo&#39;, &#39;bar&#39;, &#39;foo bar&#39; | | Datetime | Formatted according to [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339) | 2018-04-27T18:39:26.397237+00:00 | | List | Comma-separated literals wrapped in square brackets | [0], [0, 1], [&#39;foo&#39;, \&quot;bar\&quot;] |  ## Limitations - A maximum of 8 unique identifiers may be used inside a filter expression. 
func (r ApiSearchStorageCapacityDataRequest) SearchBody(searchBody SearchBody) ApiSearchStorageCapacityDataRequest {
	r.searchBody = &searchBody
	return r
}

func (r ApiSearchStorageCapacityDataRequest) Execute() (*EngineStorageCapacityDataResponse, *http.Response, error) {
	return r.ApiService.SearchStorageCapacityDataExecute(r)
}

/*
SearchStorageCapacityData Search engine storage capacity data.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiSearchStorageCapacityDataRequest
*/
func (a *ReportingAPIService) SearchStorageCapacityData(ctx context.Context) ApiSearchStorageCapacityDataRequest {
	return ApiSearchStorageCapacityDataRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return EngineStorageCapacityDataResponse
func (a *ReportingAPIService) SearchStorageCapacityDataExecute(r ApiSearchStorageCapacityDataRequest) (*EngineStorageCapacityDataResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ReportingAPIService.SearchStorageCapacityData")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/reporting/storage-capacity-data-report/search"
