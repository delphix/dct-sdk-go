...
// checks if the ListAlgorithmsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListAlgorithmsResponse{}
...
type NullableListAlgorithmsResponse struct {
	value *ListAlgorithmsResponse
	isSet bool
}

func (v NullableListAlgorithmsResponse) Get() *ListAlgorithmsResponse {
	return v.value
}

func (v *NullableListAlgorithmsResponse) Set(val *ListAlgorithmsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListAlgorithmsResponse) IsSet() bool {
	return v.isSet
}
...
func NewNullableListAlgorithmsResponse(val *ListAlgorithmsResponse) *NullableListAlgorithmsResponse {
	return &NullableListAlgorithmsResponse{value: val, isSet: true}
}
