...
// checks if the SearchAccessGroupsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SearchAccessGroupsResponse{}
...
func NewSearchAccessGroupsResponse() *SearchAccessGroupsResponse {
	this := SearchAccessGroupsResponse{}
	return &this
}
...
type NullableSearchAccessGroupsResponse struct {
	value *SearchAccessGroupsResponse
	isSet bool
}

func (v NullableSearchAccessGroupsResponse) Get() *SearchAccessGroupsResponse {
	return v.value
}

func (v *NullableSearchAccessGroupsResponse) Set(val *SearchAccessGroupsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableSearchAccessGroupsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableSearchAccessGroupsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSearchAccessGroupsResponse(val *SearchAccessGroupsResponse) *NullableSearchAccessGroupsResponse {
	return &NullableSearchAccessGroupsResponse{value: val, isSet: true}
}
