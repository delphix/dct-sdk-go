...
// checks if the ListVDBGroupsByBookmarkResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListVDBGroupsByBookmarkResponse{}
