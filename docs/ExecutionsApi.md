...
> CancelExecution(ctx, executionId).ExecutionCancelParameters(executionCancelParameters).Execute()
...
func main() {
    ...
    executionCancelParameters := *openapiclient.NewExecutionCancelParameters() // ExecutionCancelParameters |  (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    r, err := apiClient.ExecutionsApi.CancelExecution(context.Background(), executionId).ExecutionCancelParameters(executionCancelParameters).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `ExecutionsApi.CancelExecution``: %v\n", err)
 ...
 **executionCancelParameters** | [**ExecutionCancelParameters**](ExecutionCancelParameters.md) |  | 
...
> Execution GetExecutionById(ctx, executionId).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.ExecutionsApi.GetExecutionById(context.Background(), executionId).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `ExecutionsApi.GetExecutionById``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetExecutionById`: Execution
    fmt.Fprintf(os.Stdout, "Response from `ExecutionsApi.GetExecutionById`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetExecutionByIdRequest struct via the builder pattern
...
> ListExecutionEventsResponse GetExecutionEvents(ctx, executionId).Limit(limit).Cursor(cursor).Sort(sort).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.ExecutionsApi.GetExecutionEvents(context.Background(), executionId).Limit(limit).Cursor(cursor).Sort(sort).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `ExecutionsApi.GetExecutionEvents``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetExecutionEvents`: ListExecutionEventsResponse
    fmt.Fprintf(os.Stdout, "Response from `ExecutionsApi.GetExecutionEvents`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetExecutionEventsRequest struct via the builder pattern
...
> ListExecutionsResponse GetExecutions(ctx).Limit(limit).Cursor(cursor).Sort(sort).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.ExecutionsApi.GetExecutions(context.Background()).Limit(limit).Cursor(cursor).Sort(sort).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `ExecutionsApi.GetExecutions``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetExecutions`: ListExecutionsResponse
    fmt.Fprintf(os.Stdout, "Response from `ExecutionsApi.GetExecutions`: %v\n", resp)
}
```
...
> SearchExecutionEventsResponse SearchExecutionEvents(ctx, executionId).Limit(limit).Cursor(cursor).Sort(sort).SearchBody(searchBody).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.ExecutionsApi.SearchExecutionEvents(context.Background(), executionId).Limit(limit).Cursor(cursor).Sort(sort).SearchBody(searchBody).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `ExecutionsApi.SearchExecutionEvents``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `SearchExecutionEvents`: SearchExecutionEventsResponse
    fmt.Fprintf(os.Stdout, "Response from `ExecutionsApi.SearchExecutionEvents`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiSearchExecutionEventsRequest struct via the builder pattern
...
> SearchExecutionsResponse SearchExecutions(ctx).Limit(limit).Cursor(cursor).Sort(sort).SearchBody(searchBody).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.ExecutionsApi.SearchExecutions(context.Background()).Limit(limit).Cursor(cursor).Sort(sort).SearchBody(searchBody).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `ExecutionsApi.SearchExecutions``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `SearchExecutions`: SearchExecutionsResponse
