...
func main() {
    vdbGroupId := "vdbGroupId_example" // string | The ID or name of the VDBGroup.
    refreshVDBGroupParameters := *openapiclient.NewRefreshVDBGroupParameters() // RefreshVDBGroupParameters | The parameters to refresh a VDB. (optional)
 ...
 **refreshVDBGroupParameters** | [**RefreshVDBGroupParameters**](RefreshVDBGroupParameters.md) | The parameters to refresh a VDB. | 
...
func main() {
    vdbGroupId := "vdbGroupId_example" // string | The ID or name of the VDBGroup.
    rollbackVDBGroupParameters := *openapiclient.NewRollbackVDBGroupParameters() // RollbackVDBGroupParameters | The parameters to rollback a VDB. (optional)
 ...
 **rollbackVDBGroupParameters** | [**RollbackVDBGroupParameters**](RollbackVDBGroupParameters.md) | The parameters to rollback a VDB. | 
