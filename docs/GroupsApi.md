...
> DatasetGroup GetDatasetGroupById(ctx, groupId).Execute()
...
func main() {
    groupId := "groupId_example" // string | The ID of the dataset group.

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.GroupsApi.GetDatasetGroupById(context.Background(), groupId).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `GroupsApi.GetDatasetGroupById``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetDatasetGroupById`: DatasetGroup
    fmt.Fprintf(os.Stdout, "Response from `GroupsApi.GetDatasetGroupById`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetDatasetGroupByIdRequest struct via the builder pattern
...
> ListGroupsResponse GetDatasetGroups(ctx).Limit(limit).Cursor(cursor).Sort(sort).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.GroupsApi.GetDatasetGroups(context.Background()).Limit(limit).Cursor(cursor).Sort(sort).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `GroupsApi.GetDatasetGroups``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetDatasetGroups`: ListGroupsResponse
    fmt.Fprintf(os.Stdout, "Response from `GroupsApi.GetDatasetGroups`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetDatasetGroupsRequest struct via the builder pattern
...
> SearchDatasetGroupResponse SearchDatasetGroups(ctx).Limit(limit).Cursor(cursor).Sort(sort).SearchBody(searchBody).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.GroupsApi.SearchDatasetGroups(context.Background()).Limit(limit).Cursor(cursor).Sort(sort).SearchBody(searchBody).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `GroupsApi.SearchDatasetGroups``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `SearchDatasetGroups`: SearchDatasetGroupResponse
    fmt.Fprintf(os.Stdout, "Response from `GroupsApi.SearchDatasetGroups`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiSearchDatasetGroupsRequest struct via the builder pattern
