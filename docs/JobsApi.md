...
func main() {
    ...
    r, err := apiClient.JobsApi.AbandonJob(context.Background(), jobId).Execute()
    if err != nil {
...
> TagsResponse CreateJobTags(ctx, jobId).TagsRequest(tagsRequest).Execute()
...
func main() {
    jobId := "jobId_example" // string | The ID of the job.
    tagsRequest := *openapiclient.NewTagsRequest([]openapiclient.Tag{*openapiclient.NewTag("key-1", "value-1")}) // TagsRequest | Tags information for Job.

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.JobsApi.CreateJobTags(context.Background(), jobId).TagsRequest(tagsRequest).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `JobsApi.CreateJobTags``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `CreateJobTags`: TagsResponse
    fmt.Fprintf(os.Stdout, "Response from `JobsApi.CreateJobTags`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiCreateJobTagsRequest struct via the builder pattern
...
> DeleteJobTag(ctx, jobId).DeleteTag(deleteTag).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    r, err := apiClient.JobsApi.DeleteJobTag(context.Background(), jobId).DeleteTag(deleteTag).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `JobsApi.DeleteJobTag``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
}
```
...
> TagsResponse GetJobTags(ctx, jobId).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.JobsApi.GetJobTags(context.Background(), jobId).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `JobsApi.GetJobTags``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetJobTags`: TagsResponse
    fmt.Fprintf(os.Stdout, "Response from `JobsApi.GetJobTags`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetJobTagsRequest struct via the builder pattern
...
> ListJobsResponse GetJobs(ctx).Limit(limit).Cursor(cursor).Sort(sort).Execute()
...
func main() {
    ...
    sort := "id" // string | The field to sort results by. A property name with a prepended '-' signifies descending order. (optional) (default to "-start_time")

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.JobsApi.GetJobs(context.Background()).Limit(limit).Cursor(cursor).Sort(sort).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `JobsApi.GetJobs``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetJobs`: ListJobsResponse
 ...
 **sort** | **string** | The field to sort results by. A property name with a prepended &#39;-&#39; signifies descending order. | [default to &quot;-start_time&quot;]
...
> SearchJobsResponse SearchJobs(ctx).Limit(limit).Cursor(cursor).Sort(sort).SearchBody(searchBody).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.JobsApi.SearchJobs(context.Background()).Limit(limit).Cursor(cursor).Sort(sort).SearchBody(searchBody).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `JobsApi.SearchJobs``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `SearchJobs`: SearchJobsResponse
    fmt.Fprintf(os.Stdout, "Response from `JobsApi.SearchJobs`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiSearchJobsRequest struct via the builder pattern
