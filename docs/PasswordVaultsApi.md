...
> PasswordVault GetPasswordVaultById(ctx, passwordVaultId).Execute()
...
func main() {
    passwordVaultId := "passwordVaultId_example" // string | The ID of the password vault.

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.PasswordVaultsApi.GetPasswordVaultById(context.Background(), passwordVaultId).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `PasswordVaultsApi.GetPasswordVaultById``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetPasswordVaultById`: PasswordVault
    fmt.Fprintf(os.Stdout, "Response from `PasswordVaultsApi.GetPasswordVaultById`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetPasswordVaultByIdRequest struct via the builder pattern
...
> ListPasswordVaultsResponse GetPasswordVaults(ctx).Limit(limit).Cursor(cursor).Sort(sort).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.PasswordVaultsApi.GetPasswordVaults(context.Background()).Limit(limit).Cursor(cursor).Sort(sort).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `PasswordVaultsApi.GetPasswordVaults``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetPasswordVaults`: ListPasswordVaultsResponse
    fmt.Fprintf(os.Stdout, "Response from `PasswordVaultsApi.GetPasswordVaults`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetPasswordVaultsRequest struct via the builder pattern
...
> SearchPasswordVaultResponse SearchPasswordVaults(ctx).Limit(limit).Cursor(cursor).Sort(sort).SearchBody(searchBody).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.PasswordVaultsApi.SearchPasswordVaults(context.Background()).Limit(limit).Cursor(cursor).Sort(sort).SearchBody(searchBody).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `PasswordVaultsApi.SearchPasswordVaults``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `SearchPasswordVaults`: SearchPasswordVaultResponse
    fmt.Fprintf(os.Stdout, "Response from `PasswordVaultsApi.SearchPasswordVaults`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiSearchPasswordVaultsRequest struct via the builder pattern
