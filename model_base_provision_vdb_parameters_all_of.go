...
// checks if the BaseProvisionVDBParametersAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BaseProvisionVDBParametersAllOf{}
...
func (o *BaseProvisionVDBParametersAllOf) GetMasked() bool {
...
// and a boolean to check if the value has been set.
func (o *BaseProvisionVDBParametersAllOf) GetMaskedOk() (*bool, bool) {
	if o == nil || IsNil(o.Masked) {
		return nil, false
	}
...
func (o *BaseProvisionVDBParametersAllOf) HasMasked() bool {
	if o != nil && !IsNil(o.Masked) {
		return true
	}
...
func (o *BaseProvisionVDBParametersAllOf) SetMasked(v bool) {
	o.Masked = &v
}
