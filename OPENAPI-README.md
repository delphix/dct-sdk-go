...
*DataClassesAPI* | [**CreateDataClass**](docs/DataClassesAPI.md#createdataclass) | **Post** /data-classes | Create a Data Class.
...
*VDBsAPI* | [**ExportVdbFromBookmark**](docs/VDBsAPI.md#exportvdbfrombookmark) | **Post** /vdbs/{vdbId}/export-from-bookmark | Export a dSource using bookmark to physical file system
*VDBsAPI* | [**ExportVdbInPlace**](docs/VDBsAPI.md#exportvdbinplace) | **Post** /vdbs/{vdbId}/in-place-export | Convert a Virtual PDB to a physical PDB on Physical file system.
*VDBsAPI* | [**ExportVdbToAsmByBookmark**](docs/VDBsAPI.md#exportvdbtoasmbybookmark) | **Post** /vdbs/{vdbId}/asm-export-from-bookmark | Export a vdb using using bookmark to an ASM file system
...
*VDBsAPI* | [**OracleAsmInPlaceVdbExport**](docs/VDBsAPI.md#oracleasminplacevdbexport) | **Post** /vdbs/{vdbId}/asm-in-place-export | Convert a VDB/vPDB to a physical DB/PDB on Oracle ASM file system.
