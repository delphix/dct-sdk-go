...
func (r ApiGetEngineByIdRequest) Execute() (*Engine, *http.Response, error) {
	return r.ApiService.GetEngineByIdExecute(r)
}
...
func (a *EnginesApiService) GetEngineByIdExecute(r ApiGetEngineByIdRequest) (*Engine, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "EnginesApiService.GetEngineById")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/engines/{engineId}"
...
func (r ApiGetEnginesRequest) Execute() (*ListEnginesResponse, *http.Response, error) {
...
func (a *EnginesApiService) GetEnginesExecute(r ApiGetEnginesRequest) (*ListEnginesResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
