...
// checks if the RollbackVDBFromBookmarkResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RollbackVDBFromBookmarkResponse{}
...
func NewRollbackVDBFromBookmarkResponse() *RollbackVDBFromBookmarkResponse {
	this := RollbackVDBFromBookmarkResponse{}
	return &this
}
...
type NullableRollbackVDBFromBookmarkResponse struct {
	value *RollbackVDBFromBookmarkResponse
	isSet bool
}

func (v NullableRollbackVDBFromBookmarkResponse) Get() *RollbackVDBFromBookmarkResponse {
	return v.value
}

func (v *NullableRollbackVDBFromBookmarkResponse) Set(val *RollbackVDBFromBookmarkResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableRollbackVDBFromBookmarkResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableRollbackVDBFromBookmarkResponse) Unset() {
	v.value = nil
	v.isSet = false
}
...
func NewNullableRollbackVDBFromBookmarkResponse(val *RollbackVDBFromBookmarkResponse) *NullableRollbackVDBFromBookmarkResponse {
	return &NullableRollbackVDBFromBookmarkResponse{value: val, isSet: true}
}
