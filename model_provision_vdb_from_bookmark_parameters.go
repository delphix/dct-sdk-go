...
func (o *ProvisionVDBFromBookmarkParameters) GetMasked() bool {
...
// and a boolean to check if the value has been set.
func (o *ProvisionVDBFromBookmarkParameters) GetMaskedOk() (*bool, bool) {
	if o == nil || IsNil(o.Masked) {
		return nil, false
	}
...
func (o *ProvisionVDBFromBookmarkParameters) HasMasked() bool {
	if o != nil && !IsNil(o.Masked) {
		return true
	}
...
func (o *ProvisionVDBFromBookmarkParameters) SetMasked(v bool) {
	o.Masked = &v
}
