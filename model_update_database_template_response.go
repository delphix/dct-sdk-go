...
// checks if the UpdateDatabaseTemplateResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateDatabaseTemplateResponse{}
...
func NewUpdateDatabaseTemplateResponse() *UpdateDatabaseTemplateResponse {
	this := UpdateDatabaseTemplateResponse{}
	return &this
}
...
type NullableUpdateDatabaseTemplateResponse struct {
	value *UpdateDatabaseTemplateResponse
	isSet bool
}

func (v NullableUpdateDatabaseTemplateResponse) Get() *UpdateDatabaseTemplateResponse {
	return v.value
}

func (v *NullableUpdateDatabaseTemplateResponse) Set(val *UpdateDatabaseTemplateResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateDatabaseTemplateResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateDatabaseTemplateResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateDatabaseTemplateResponse(val *UpdateDatabaseTemplateResponse) *NullableUpdateDatabaseTemplateResponse {
	return &NullableUpdateDatabaseTemplateResponse{value: val, isSet: true}
}
