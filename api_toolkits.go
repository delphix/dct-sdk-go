...
// Tags information for Toolkit.
func (r ApiCreateToolkitTagsRequest) TagsRequest(tagsRequest TagsRequest) ApiCreateToolkitTagsRequest {
	r.tagsRequest = &tagsRequest
	return r
}

func (r ApiCreateToolkitTagsRequest) Execute() (*TagsResponse, *http.Response, error) {
	return r.ApiService.CreateToolkitTagsExecute(r)
}

/*
CreateToolkitTags Create tags for a toolkit.
...
func (a *ToolkitsAPIService) CreateToolkitTagsExecute(r ApiCreateToolkitTagsRequest) (*TagsResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/toolkits/{toolkitId}/tags"
...
func (r ApiGetToolkitTagsRequest) Execute() (*TagsResponse, *http.Response, error) {
	return r.ApiService.GetToolkitTagsExecute(r)
}

/*
GetToolkitTags Get tags for a Toolkit.
...
func (r ApiGetToolkitsRequest) Limit(limit int32) ApiGetToolkitsRequest {
	r.limit = &limit
	return r
}

// Cursor to fetch the next or previous page of results. The value of this property must be extracted from the &#39;prev_cursor&#39; or &#39;next_cursor&#39; property of a PaginatedResponseMetadata which is contained in the response of list and search API endpoints.
func (r ApiGetToolkitsRequest) Cursor(cursor string) ApiGetToolkitsRequest {
	r.cursor = &cursor
	return r
}

// The field to sort results by. A property name with a prepended &#39;-&#39; signifies descending order.
func (r ApiGetToolkitsRequest) Sort(sort string) ApiGetToolkitsRequest {
	r.sort = &sort
	return r
}

func (r ApiGetToolkitsRequest) Execute() (*ListToolkitResponse, *http.Response, error) {
	return r.ApiService.GetToolkitsExecute(r)
}

/*
GetToolkits List all toolkits.
...
func (a *ToolkitsAPIService) GetToolkitsExecute(r ApiGetToolkitsRequest) (*ListToolkitResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/toolkits"
...
// Maximum number of objects to return per query. The value must be between 1 and 1000. Default is 100.
func (r ApiSearchToolkitsRequest) Limit(limit int32) ApiSearchToolkitsRequest {
	r.limit = &limit
	return r
}

// Cursor to fetch the next or previous page of results. The value of this property must be extracted from the &#39;prev_cursor&#39; or &#39;next_cursor&#39; property of a PaginatedResponseMetadata which is contained in the response of list and search API endpoints.
func (r ApiSearchToolkitsRequest) Cursor(cursor string) ApiSearchToolkitsRequest {
	r.cursor = &cursor
	return r
}

// The field to sort results by. A property name with a prepended &#39;-&#39; signifies descending order.
func (r ApiSearchToolkitsRequest) Sort(sort string) ApiSearchToolkitsRequest {
	r.sort = &sort
	return r
}
...
func (r ApiSearchToolkitsRequest) SearchBody(searchBody SearchBody) ApiSearchToolkitsRequest {
	r.searchBody = &searchBody
	return r
}

func (r ApiSearchToolkitsRequest) Execute() (*SearchToolkitResponse, *http.Response, error) {
	return r.ApiService.SearchToolkitsExecute(r)
}

/*
SearchToolkits Search for toolkits.
...
func (a *ToolkitsAPIService) SearchToolkitsExecute(r ApiSearchToolkitsRequest) (*SearchToolkitResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/toolkits/search"
