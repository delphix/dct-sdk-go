...
// checks if the SearchDatasetGroupResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SearchDatasetGroupResponse{}
...
func NewSearchDatasetGroupResponse() *SearchDatasetGroupResponse {
	this := SearchDatasetGroupResponse{}
	return &this
}
...
type NullableSearchDatasetGroupResponse struct {
	value *SearchDatasetGroupResponse
	isSet bool
}

func (v NullableSearchDatasetGroupResponse) Get() *SearchDatasetGroupResponse {
	return v.value
}

func (v *NullableSearchDatasetGroupResponse) Set(val *SearchDatasetGroupResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableSearchDatasetGroupResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableSearchDatasetGroupResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSearchDatasetGroupResponse(val *SearchDatasetGroupResponse) *NullableSearchDatasetGroupResponse {
	return &NullableSearchDatasetGroupResponse{value: val, isSet: true}
}
